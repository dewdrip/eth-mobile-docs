...
:::info
We are only storing the plain private key in memory, it's never stored in disk files for security reasons. Checkout the code [here](https://github.com/dewdrip/eth-mobile/blob/main/packages/hardhat/scripts/generateAccount.ts).
:::
